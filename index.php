        ...
        >
          ...
          <div class="form-field mb-5">
            ...
            <input
              ...
              required
            />
            <span class="form-field-error" id="phone_number_error"
              >format should 09xxxxxxxxx</span
            >
          </div>
    ...
    <main class="main">
      ...
      <section class="pregis-event px-3">
        <div class="pregis-event-container max-w-screen-xl mx-auto">
          ...
          <div class="chart flex flex-col lg:gap-14 lg:flex-row lg:mb-14">
            <div
            ...
            >
              ...
              <p class="lg:text-center">
                Sign up now and get a 100 pesos welcome bonus upon registration.
              </p>
            </div>
            ...
            >
              ...
              <p class="lg:text-center">
                Recharge for the first time and accumulate 5% of the recharge
                amount.
              </p>
            </div>
            ...
            >
              <div class="chart-item-image">
                <img
                  src="./img/assets/cash-3.png"
                  alt=""
                  class="img object-contain"
                />
              </div>
              <p class="lg:text-center">
                The maximum amount that can be accumulated is 10,000 pesos.
              </p>
            </div>
          </div>
    ...
    <footer class="footer px-2 pt-14 pb-3">
      <div class="footer-container max-w-screen-xl mx-auto">
        <div class="flex gap-5 justify-center">
          <a href="#"
            ><img src="./img//assets/soc-sns.png" alt="" class="w-7"
          /></a>
          <a href="#"
            ><img src="./img//assets/soc-discord.png" alt="" class="w-7"
          /></a>
          <a href="#"
            ><img src="./img//assets/soc-youtube.png" alt="" class="w-7"
          /></a>
          <a href="#"
            ><img src="./img//assets/soc-facebook.png" alt="" class="w-7"
          /></a>
          <a href="#"
            ><img src="./img//assets/soc-twitter.png" alt="" class="w-7"
          /></a>
          <a href="#"
            ><img src="./img//assets/soc-link.png" alt="" class="w-7"
          /></a>
        </div>

        <span class="footer-separator mt-5 mb-7"></span>

        <a href="https://blockwin.fun/acewin/" class="w-24 mx-auto block mb-2"
          ><img src="./img/assets/logo.png" alt="" class=""
        /></a>
