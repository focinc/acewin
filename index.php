...
<html lang="en">
  ...
  <body>
          ...
          <form class="form" method="POST" action="./process/register.php">
            ...
            <div class="form-field flex items-start gap-2 mb-10">
              ...
              <label for="" class="form-field-label"
                >I agree to collecting and using my personal information.</label
              >
            </div>
    ...
    <div id="stsmdl" class="modal px-3">
      <div class="card">
        <div id="mdl-icn-stts" class="icon">
          <img id="mdl-icn" src="./image/icon-close.png" alt="modal icon" />
        </div>

        <div class="body text-center mb-4">
          <h3 id="mdl-ttl" class="title mb-2">Contact Number Already Exists</h3>
          <p id="mdl-ctnt" class="content">
        ...
        <div class="hero-container max-w-screen-xl mx-auto px-2">
          <div class="hero-content flex flex-col items-center">
            <a href="#" class="logo mb-2"
              ><img src="./image/logo.png" alt="logo" class="w-56"
            /></a>
            ...
            <div class="btn-group flex gap-3">
              <a href="#"
                ><img src="./image/btn-google-play.png" alt="download app"
              /></a>
              <a href="#"
                ><img src="./image/btn-play-store.png" alt="download app"
              /></a>
            </div>
          </div>
        </div>
    ...
    <footer class="footer">
      ...
      >
        ...
        <div class="footer-soc-meds flex gap-4 mb-5">
          <a href="#"
            ><img src="./image/icon-twitter.png" alt="socmed" class="w-8"
          /></a>
          <a href="#"
            ><img src="./image/icon-facebook.png" alt="socmed" class="w-8"
          /></a>
          <a href="#"
            ><img src="./image/icon-discord.png" alt="socmed" class="w-8"
          /></a>
          <a href="#"
            ><img src="./image/icon-play.png" alt="socmed" class="w-8"
          /></a>
          <a href="#"
            ><img src="./image/icon-youtube.png" alt="socmed" class="w-8"
          /></a>
          <a href="#"
            ><img src="./image/icon-link.png" alt="socmed" class="w-8"
          /></a>
        </div>
